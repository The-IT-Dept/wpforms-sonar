    ...
    var app = {
        ...
        getFields: function () {
            ...
            fields.forEach(function (el) {
                ...
                app.showDebugMessage("type: " + type)
                ...
                const place_field = document.querySelector(".wpforms-form .custom_place_id_field > input");
        ...
        updateFields: function (currentFieldPlace, place) {
            ...
            if (currentFieldPlace.additionalFields.place_id.el) {
                ...
                console.log("value updated", currentFieldPlace.additionalFields.place_id.el.value)
            }
